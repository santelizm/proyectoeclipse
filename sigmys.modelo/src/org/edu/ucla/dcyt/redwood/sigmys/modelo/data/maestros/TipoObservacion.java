...
@Table(name = "tipoobservacion", schema = "sigmys")
@Entity
public class TipoObservacion implements Comparable<TipoObservacion>,
		Serializable {
	...
	@Id
	@SequenceGenerator(name = "TIPOOBSERVACION_ID_GENERATOR", sequenceName = "TIPOOBSERVACION_CODIGO_SEQ", allocationSize = 1, schema = "sigmys")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "TIPOOBSERVACION_ID_GENERATOR")
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TipoObservacion other = (TipoObservacion) obj;
		if (id != other.id)
			return false;
		if (nombre == null) {
	...
	@Override
	public int compareTo(TipoObservacion o) {
